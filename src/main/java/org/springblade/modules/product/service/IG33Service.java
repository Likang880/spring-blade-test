 ...
 * @since 2021-08-10
 */
public interface IG33Service extends IService<G33> {
	 ...
	 * @return
	 */
	IPage<G33VO> selectG33Page(IPage<G33VO> page, G33VO g33);

	IPage<G33> selectG33Query(IPage<G33> page, G33DTO g33DTO);
